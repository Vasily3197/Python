# В одной из практических работ мы делали задачу, где папа-программист написал для сына программу, которая просит его угадать число. 
# Недостаток программы был в том, что бедному сыну приходилось её каждый раз перезапускать, 
...
digit = int (input("Загадайте число: "))
quest = 0
count = 0
while quest != digit:
    count += 1
    quest = int (input("Угадайте число: "))
    if quest < digit:
