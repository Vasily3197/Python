...
educational_grant = int (input("Enter the student's scholarship: "))
...
for month in range(1, month + 1):
    ...
    are_missing += (expenses - educational_grant) 

    print(f"{month} month expenses: {round(expenses, 1)}. {round(are_missing, 2)} are missing ")
print()
print(f"You need to ask your parents for {round(are_missing, 2)}")
