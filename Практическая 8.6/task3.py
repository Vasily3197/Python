...
time = int (input("Сколько секунд разогревать? " ))

for second in range (time, 0, -1):
    print(f"Количество секунд {second}")
    reverse_timer = int (input ("Готовы ли вы забрать еду? "))
    
    if reverse_timer == 1:
        print ("Ваша еда готова, можно забрать {second}")
        break
